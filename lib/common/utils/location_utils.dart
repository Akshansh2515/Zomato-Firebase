...
Future<Position> getCurrentLocation() async {
  return await Geolocator.getCurrentPosition(
    locationSettings: const LocationSettings(
      // Correct parameter name is 'locationSettings'
      accuracy: LocationAccuracy.high, // Use high accuracy setting
      distanceFilter: 100, // Optional: specify distance filter in meters
    ),
  );
}
